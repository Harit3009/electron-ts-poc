...
var VideoComponent = function () {
    ...
    var _a = React.useState(), srcObject = _a[0], setSrcObject = _a[1];
    var _b = React.useState(""), deviceId = _b[0], setDeviceID = _b[1];
    var getScreenMedia = function () {
        navigator.mediaDevices
            ...
            console.log("errored in video ", { error: error });
        });
    };
    ...
    return (<div className="d-flex flex-column">
      <video onLoadedMetadata={function (meta) {
            var _a;
            (_a = vidRef.current) === null || _a === void 0 ? void 0 : _a.play();
        }} ref={vidRef}></video>
