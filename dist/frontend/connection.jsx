...
var Connection = function () {
    ...
    React.useEffect(function () {
        ...
        window.electron.getLocalSDP(function (sdp) {
            ...
            createAndSetLocalOffer().then(function (offer) {
                return window.electron.saveLocalSDP(offer);
            });
        });
    }, []);
    var createAndSetLocalOffer = function () { return __awaiter(void 0, void 0, void 0, function () {
        var offer;
